...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item The archival storage is located at \texttt{/drives/<user>/archive/group (or /archive3/group/)}
    \end{enumerate}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item Login to the headnode: \texttt{$<$username$>$@headnode.hpc.ista.ac}
        \item The storage is located at \texttt{/drives/<user>/home (or /fs3/home/)}
    \end{enumerate}
    \item Mapping the drives on your local \href{https://it.pages.ist.ac.at/docs/it-documentation/fileservers/fileshare/}{machine}
\end{enumerate}
